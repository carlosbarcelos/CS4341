...
public class Referee
{
	...
	private double movesMade = 0;
	private double timeTaken = 0;
	private double initializationTime = 0;
	...
	public int judge() {
		...
		while(winner == 0)
		{
			if(board.turn == 1) // Player 1's turn
			{
				...
				catch (TimeoutException e)
		        {
					...
					movesMade += 0.5; // Add the move to the counter
				}				
		...
		case 1:
			...
			this.timeTaken = (double)(System.currentTimeMillis() - this.initializationTime) / 1000.0;
			out.println("  Moves made: " + this.movesMade); // Player 1 then Player 2 is one round
			out.println("  Time taken:    " + this.timeTaken);
			return 1;
		case 2:
			out.println(player2.getName() +" wins.");
			//More print information
